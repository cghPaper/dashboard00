...
public class BoardMapperTests {
	 ...
	 * 
	 * mapper.insert(board); log.info("board : " + board); }
	 * 
	 * @Test public void testInsertSelectKey() { BoardVO board = new BoardVO();
	 * board.setTitle("새로 작성하는 글 select key");
	 * board.setContent("새로 작성하는 내용 select key"); board.setWriter("newbie2");
	 * 
	 * mapper.insertSelectKey(board); log.info("board : " + board); }
	 */
